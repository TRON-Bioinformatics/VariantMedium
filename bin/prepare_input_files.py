...
# Detect whether input is CSV or TSV
...
# Generate TSVs (written into current dir, NOT output_dir)
def make_input(df, skip_preprocessing, output_dir):
    ...
    for _, row in df.iterrows():
        ...
        # pairs_w_cands
        extratrees_tsv = out(f"output_01_04_candidates_extratrees/Production_Model/{sample}.tsv")
        print(
            sample,
            "call",
            pair,
